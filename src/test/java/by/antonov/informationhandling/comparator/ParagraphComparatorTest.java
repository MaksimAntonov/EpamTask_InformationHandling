...
public class ParagraphComparatorTest {
  ...
  public void compareTest() {
    ...
    List<String> actual = rootComponent
        .getComponentsByType(ComponentType.PARAGRAPH).orElse(new ArrayList<>())
        .stream().sorted(componentComparator)
        .map(Object::toString)
        .collect(Collectors.toList());
    List<String> expected = SearchService.getComponentsByType(expectedComponent, ComponentType.PARAGRAPH)
